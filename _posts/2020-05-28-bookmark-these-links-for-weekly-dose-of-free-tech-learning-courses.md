...
+ [Coursera](https://www.coursera.org/search?query=free+courses+software&index=prod_all_products_term_optimization&allLanguages=English&skills=Data+Analysis&skills=Leadership+And+Management&skills=Computer+Programming&skills=Algorithms&skills=Python+Programming&entityTypeDescription=Courses)
...
# Getting Access to Azure courses library (350+ courses) on Pluralsight free for 5 years:
[Pluralsight Azure Free For 5 Years](https://www.sunnyoswal.com/azure/2019/08/13/how-to-access-microsoft-azure-related-courses-on-pluralsight-free-for-5-years.html)
